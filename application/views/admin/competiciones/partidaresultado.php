		...
		<div class="row">
               ...
               <?php 
				...
				<form
					...
					<div class="row">
						<div>
						 <label class="form-control" for="mapa1_resultado_local">Local
						  </label>
						...
						<label class="form-control" for="mapa1_resultado_empate">Empate
						 ...
						 <div>
						 <label class="form-control" for="mapa1_resultado_visitante">Visitante
						  </label>
					...
					<div class="row">
					<div>
						 <label class="form-control" for="mapa2_resultado_local">Local
						  </label>
					...
					<div>
						<label class="form-control" for="mapa2_resultado_empate">Empate
						 ...
						 <label class="form-control" for="mapa2_resultado_visitante">Visitante
						  </label>
					...
					<div class="row">
					<div>
						 <label class="form-control" for="mapa3_resultado_local">Local
						  </label>
						...
						<label class="form-control" for="mapa3_resultado_empate">Empate
						 ...
						 <label class="form-control" for="mapa3_resultado_visitante">Visitante
						  </label>
					...
					<?php if(!$id_equipo){?>
                     ...
                     <?php }else{?>
                         <input type="submit" class="form-control"
							name="guardar_partida" value="Proponer nuevos cambios" />
                   <?php  }?>
